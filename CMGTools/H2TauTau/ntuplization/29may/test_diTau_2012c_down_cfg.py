...
useParked           = True
MC_trigger_matching = True   ## don't touch unless you want to test something tricky
...
if useParked :
  mc_tauEffWeight    = 'eff2012IsoParkedTau19fb_Simone'   ####### TO BE UPDATED BY SIMONE, 2012D for all as of may 15 ########
...
from CMGTools.H2TauTau.proto.samples.run2012.diTau_Colin_Feb8_down import *
...
#selectedComponents = [HiggsGGH120,data_Run2012D_PromptReco_v1]
