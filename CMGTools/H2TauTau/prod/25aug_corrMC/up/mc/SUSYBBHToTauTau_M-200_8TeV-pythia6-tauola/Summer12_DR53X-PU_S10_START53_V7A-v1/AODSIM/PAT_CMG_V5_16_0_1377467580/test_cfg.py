...
datasetInfo = ("cmgtools_group","/SUSYBBHToTauTau_M-200_8TeV-pythia6-tauola/Summer12_DR53X-PU_S10_START53_V7A-v1/AODSIM/PAT_CMG_V5_16_0","cmgTuple.*\.root$")
###ProductionTaskHook$$$
...
file('Expandedfull_cfg.py','w').write(process.dumpPython())
