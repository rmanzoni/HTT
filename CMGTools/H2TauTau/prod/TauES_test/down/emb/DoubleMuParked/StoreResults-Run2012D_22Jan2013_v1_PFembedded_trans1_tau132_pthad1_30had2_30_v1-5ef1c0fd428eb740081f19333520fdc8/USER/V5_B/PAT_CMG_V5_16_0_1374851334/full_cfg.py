...
channel    = 'di-tau' #'tau-mu' # 'tau-mu' #'di-tau' 'all' 'tau-ele'
jetRecalib = False
useCHS     = False 
newSVFit   = True
tauScaling = -1
...
datasetInfo = ("cmgtools","/DoubleMuParked/StoreResults-Run2012D_22Jan2013_v1_PFembedded_trans1_tau132_pthad1_30had2_30_v1-5ef1c0fd428eb740081f19333520fdc8/USER/V5_B/PAT_CMG_V5_16_0","cmgTuple.*\.root$")
###ProductionTaskHook$$$
...
if channel=='all':
   ...
   # CHANGING TES -------------------------------------------
   process.cmgDiTauCor.cfg.shift1Prong1Pi0     = cms.double(0.012)
   process.cmgDiTauCor.cfg.shift3Prong        = cms.double(0.012)
...
if channel=='tau-mu' or channel=='all':
    addTauMuOutput( process, debugEventContent, addPreSel=False, RH_Emedded=isEmbedded)
if channel=='tau-ele' or channel=='all':
    addTauEleOutput( process, debugEventContent, addPreSel=False, RH_Emedded=isEmbedded)
## if channel=='mu-ele' or channel=='all':
##     addMuEleOutput( process, debugEventContent, addPreSel=False, RH_Emedded=isEmbedded)
if channel=='di-tau' or channel=='all':
    addDiTauOutput( process, debugEventContent, addPreSel=False, RH_Emedded=isEmbedded)
