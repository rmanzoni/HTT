...
#         var('l2JetInvMass')
        ...
        ####### TRIGGER MATCHING
        varInt( 'l1TrigMatched_MuTau'    )
        varInt( 'l2TrigMatched_MuTau'    )
...
#            fill('svfitMassSmeared', event.diLepton.massSVFit()*scale*shift )
	...
	if hasattr(event,"pthgen"):
	  fill('pthgen',event.pthgen)
	else :
	  fill('pthgen', -1 )

        # trigger matching for diTau trigger present in parked dataset 
	if hasattr(event,"l1TrigMatched_MuTau") and hasattr(event,"l1TrigMatched_MuTau") :
          fill( 'l1TrigMatched_MuTau' , event.l1TrigMatched_MuTau )
          fill( 'l2TrigMatched_MuTau' , event.l2TrigMatched_MuTau )
	else:
          fill( 'l1TrigMatched_MuTau' , -1)
          fill( 'l2TrigMatched_MuTau' , -1)
	...
	if hasattr(event,"triggerWeight_diTau") and hasattr(event,"triggerEffMC_diTau") and hasattr(event,"triggerEffData_diTau"):
        ...
        hastt = 0
        if hasattr(event,'hastt') and event.hastt == 1: hastt = 1
        fill('hastt', hastt)
        ...
        #if hasattr(event,"l2TrigMatched_diTau") and event.l2TrigMatched_diTau > 0.5 and event.HLT_DoubleMediumIsoPFTau35_Trk5_eta2p1_v6<0.5 :
        #  import pdb ; pdb.set_trace()
