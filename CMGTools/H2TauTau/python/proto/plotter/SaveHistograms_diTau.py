...
#       TightIsoOS.Hist('DYJets').Add(TightIsoOS.Hist('TTjets_emb')
    ...
    if susy :
      ...
      TightIsoOS.Hist('HiggsGGH125').Add(TightIsoOS.Hist('HiggsWH125'))  ## adding SM Higgs as a bkg
      TightIsoOS.Hist('HiggsGGH125').Add(TightIsoOS.Hist('HiggsZH125'))  ## adding SM Higgs as a bkg
      TightIsoOS.Hist('HiggsGGH125').Add(TightIsoOS.Hist('HiggsttH125'))  ## adding SM Higgs as a bkg
