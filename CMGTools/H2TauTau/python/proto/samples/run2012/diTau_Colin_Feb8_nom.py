...
#     '/WH_ZH_TTH_.*ToWW.*START53.*'               :'HiggsVHtoWW',
    ...
    #'/TTJets_FullLeptMGDecays_8TeV-madgraph/StoreResults.*' : 'TTJets_emb',
...
allsamples1.extend( mc_radion )
# pat1 = '%HTT_23Jun_manzoni_Nom'
pat1 = '%HTT_22Jul_manzoni_Nom'

allsamples2 = copy.copy( mc_higgs )
allsamples2.extend( mc_higgs_susy )
allsamples2.extend( ztt_mc_ewk )
pat2 = '%HTT_24Jul_newTES_manzoni_Nom' # with 26Aug
# pat2 = '%HTT_22Jul_manzoni_Nom' # with 29Jul

allsamples3 = copy.copy( embed_list )
# pat3 = '%16_0_B/HTT_23Jun_manzoni_Nom'
# pat3 = '%HTT_22Jul_manzoni_Nom'
pat3 = '%HTT_24Jul_newTES_manzoni_Nom'
