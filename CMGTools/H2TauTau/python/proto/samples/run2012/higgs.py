...
for h in mc_higgs:
    ...
    try:
        ...
        if process=='VH':
            xSectionWH  = 0.5 * (yrparser8TeV.get(mass-1.)['WH'] ['sigma'] + yrparser8TeV.get(mass+1.)['WH']['sigma'])
            xSectionZH  = 0.5 * (yrparser8TeV.get(mass-1.)['ZH'] ['sigma'] + yrparser8TeV.get(mass+1.)['ZH']['sigma'])
            xSectionttH = 0.5 * (yrparser8TeV.get(mass-1.)['TTH']['sigma'] + yrparser8TeV.get(mass+1.)['ZH']['sigma'])
            xSection    = xSectionWH + xSectionZH + xSectionttH
        else:
    ...
    h.xSectionWH  = xSectionWH  * br
    h.xSectionZH  = xSectionZH  * br
    h.xSectionttH = xSectionttH * br
