pathsAndFilters = {
    ...
    ## single Mu & muTau control triggers, needed for trigger efficiency measurement
    'HLT_IsoMu24_eta2p1_v13'                             : ("hltL3crIsoL1sMu16Eta2p1L1f0L2f16QL3f24QL3crIsoRhoFiltered0p15"),
    ### RICCARDO: I want to match the tau, thus I hack the filters and put the tau filter twice
    #'HLT_IsoMu18_eta2p1_MediumIsoPFTau25_Trk5_eta2p1_v7' : ("hltPFTau25TrackPt5MediumIsolationProng4","hltPFTau25TrackPt5MediumIsolationProng4"),
    #'HLT_IsoMu18_eta2p1_MediumIsoPFTau25_Trk5_eta2p1_v7' : ("hltPFTau25TrackPt5MediumIsolationProng4IsoMuVertex","hltPFTau25TrackPt5MediumIsolationProng4IsoMuVertex"),
    #'HLT_IsoMu18_eta2p1_MediumIsoPFTau25_Trk5_eta2p1_v7' : ("hltPFTau25TrackPt5MediumIsolationProng4","hltPFTau25TrackPt5MediumIsolationProng4"),
    #'HLT_IsoMu18_eta2p1_MediumIsoPFTau25_Trk5_eta2p1_v7' : ("hltPFTau25","hltPFTau25"),
    ### LAST FILTER
    'HLT_IsoMu18_eta2p1_MediumIsoPFTau25_Trk5_eta2p1_v7' : ("hltOverlapFilterIsoMu18PFTau25TrackPt5Prong4","hltOverlapFilterIsoMu18PFTau25TrackPt5Prong4"),
    ### BEFORE VERTEX
    #'HLT_IsoMu18_eta2p1_MediumIsoPFTau25_Trk5_eta2p1_v7' : ("hltPFTau25TrackPt5MediumIsolationProng4","hltPFTau25TrackPt5MediumIsolationProng4"),
